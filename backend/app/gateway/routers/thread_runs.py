...
class RunCreateRequest(BaseModel):
    ...
    filter_subagent_messages: bool = Field(default=False, description="Filter out subagent namespace messages from the SSE stream")
    filter_thinking: bool = Field(default=False, description="Strip thinking/reasoning content from AI messages in the SSE stream")
    filter_intermediate_steps: bool = Field(default=False, description="Filter out tool calls, tool results and intermediate agent steps from the SSE stream")
